...
// Using one main database socket means request having to wait for that session.
...
// you'll likely build up loads of dud connections and hit a connection limit.
